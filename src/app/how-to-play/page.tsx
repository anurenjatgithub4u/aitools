  ...
  return (
    <main className="landing page">
      ...
      <section><h2>Cricket — batting and bowling</h2>
        ...
        <p><b>Batting:</b> it is all in the timing. Use ◀ ▶ to shuffle across the crease and press Bat as the ball reaches you. Perfect timing drives it for six; early pulls it high where a fielder can catch it; late squeezes it along the ground; miss a straight one and you are bowled. After a shot, press <b>Run</b> (or W) to run with the batter at the other end — press again for a second — but the fielder throws at your stumps, and if you are mid-pitch when it lands you are run out.</p>
