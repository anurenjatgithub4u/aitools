  ...
  return (
    <main className="landing page">
      ...
      <section><h2>Dates, gifts and the rides</h2>
        <p>Walk up to anyone and a card appears: tap an opener to break the ice, or invite them for a coffee at Chai Corner, the pier bench, a candle-lit table on the sand, the campfire, the sunset bench at Lighthouse Point, the Sunset Wheel or the marina boat. Gifts (🌹 🍦 ☕ 🧸 🍫 💌) are free and show on their profile. The fairground rides take two: walk to the gate and press E with someone beside you. There are seven — the Sky Wheel by Neon Lane, the carousel in Central Park, the chair swing by the Skate Park, the pirate ship on the beach, the <b>Sky Drop</b> tower that winches you 20 m into the air and drops you, the <b>Spinning Teacups</b> on the sand, and the <b>Seaside Coaster</b>, a full circuit behind the dunes with a chain lift, a first drop and two camelbacks that you ride from the front car. A ride costs 5 🪙 — gold coins lie all over the city (walk or drive over them), and every finished task pays 5.</p></section>
