...
export const ALL_DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    terrain: { amp: 1.6, flatRadius: 40, base: 3, rim: 282, coast: 215, island: 300, flats: [{ x: 70, z: 200, r: 41, blend: 14 }, { x: 425, z: 35, r: 38, blend: 14 }, { x: 50, z: -86, r: 24, blend: 12 }], water: { level: 0, color: 0x3a8fc4 },
      lands: [{ cx: -105, cz: 330, r: 150, base: 3, amp: 1.4, hills: [{ x: -200, z: 430, r: 40, h: 9 }, { x: 10, z: 420, r: 40, h: 8 }] }, { cx: 400, cz: 0, r: 135, base: 4, amp: 2.2, hills: [{ x: 420, z: -30, r: 40, h: 14 }, { x: 380, z: 60, r: 26, h: -10 }, { x: 500, z: 0, r: 30, h: 7 }] }] },
